...
<form class="bg-gradient-to-r from-cyan-500 to-blue-500 w-full h-screen flex flex-col justify-center items-center">
    <div class=" flex flex-col justify-center items-center backdrop-blur-sm bg-black-rgba rounded-xl px-10 py-20 lg:px-24 lg:py-40">
        ...
        <a href="a.html" class="bg-blue-400 py-1.5 px-4 mt-10 rounded-xl md:py-3 md:px-10 hover:bg-blue-500 active:translate-y-0.5">داخلبوون</a>
    </div>
</form>
</body>
</html>