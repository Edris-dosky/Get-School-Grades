...
<form method="POST" action="" class="bg-gradient-to-r from-cyan-500 to-blue-500 w-full h-screen flex flex-col justify-center items-center">
    <div class=" flex flex-col justify-center items-center backdrop-blur-sm bg-black-rgba rounded-xl px-10 py-20 lg:px-24 lg:py-40">
        ...
        <input type="text" name="pass" value="<?php echo htmlspecialchars($_POST['pass'] ?? ""); ?>" placeholder="وشەی نهێنی" required class="m-8 lg:w-80 lg:my-16 py-1 border-b text-end outline-none bg-transparent focus:border-blue-400 transition-all text-white md:text-xl">
        <p class=" text-red-300 "> <?php echo isset($_POST['submit']) ? $error['result'] : ''; ?> </p>
